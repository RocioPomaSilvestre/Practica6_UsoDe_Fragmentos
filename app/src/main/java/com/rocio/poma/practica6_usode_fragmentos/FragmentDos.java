...
public class FragmentDos extends Fragment {
        ...
        ContadorListener contadorListener;
    ...
    public void onResume() {
        TextView txtValueAct=getView().findViewById(R.id.texValorActual);
        txtValueAct.setText(String.valueOf(contadorListener.getValorActualContador()));
        super.onResume();
    }

    public void setConttadorListener(ContadorListener conttadorListener){
        this.contadorListener=conttadorListener;
    }
}